...
import dentistImg from '../../img/tooth-or.png';
...
export class DentistVisit extends Visit {
   ...
   generateCardHtml() {
      ...
      let lastVisitDateString = this.dateOfLastVisit
         ? `${changeDateRecord(this.dateOfLastVisit)}`
         : 'немає, цей візит є першим';
      ...
      return `
        ...
        <div class="card__expand-collapse-container ${expandClass}">
          ...
          <p class="card__text"><span class="card__text-title">Дата попереднього візиту: </span>${lastVisitDateString}</p>
